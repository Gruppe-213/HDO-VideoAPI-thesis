...
gjennom E2E-fase~9 og manuell Grafana-sjekk
(jf.\ avsnitt~\ref{sec:e2e-testing}).
...
\texttt{VideoProviderFactoryTests.GetProvider\_MixedCaseKey\_ReturnsRegisteredProvider}
bekreftet case-insensitivt provider-oppslag med \texttt{"NhN"} som testdata.
