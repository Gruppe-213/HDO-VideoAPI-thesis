...
\section{Eksisterende videoløsninger}
\label{sec:eksisterende}
HDO leverer i dag to separate videoløsninger til den akuttmedisinske kjede. Begge følger arbeidsflyten beskrevet i avsnitt~\ref{sec:hdo} og bruker \gls{webrtc} for å strømme kryptert video fra innringers kamera til operatøren \cite{hdo_oppgave}.
