...
Problemet VideoAPI løser kan angripes på flere måter. Dette avsnittet
...
Et beslektet eksempel finnes hos Singh~\cite{singh2026videio}, som
...
\draw[arr] (api.east) to[out=20,  in=180] (ant.west)
 % node[midway, below, lbl] {oversetter};
...
\begin{table}[H]
\centering
\caption{Sammenligning av tilnærminger for integrasjon mot heterogene videomotorer.}
...
isolert i provider-laget. Hvorvidt arkitekturen faktisk oppfyller
kravene fra HDO evalueres i kapittel~\ref{ch:diskusjon}.