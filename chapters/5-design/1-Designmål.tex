...
% Designet av VideoAPI tok utgangspunkt i kravspesifikasjonen fra HDO. Løsningen skulle fungere som en mellomvare mellom klientene og videomotorene AntMedia Server og NHN Video. Målet var å tilby ett felles API som
...
Designet av VideoAPI tok utgangspunkt i kravspesifikasjonen fra HDO. Løsningen skulle fungere som en mellomvare mellom klientene og videomotorene AntMedia Server og NHN Video, og tilby ett felles \gls{api} som kunne rute kall til valgt backend uten at klienten måtte kjenne detaljene i hver motor \cite{hdo_kravspec}. Siden de to motorene har ulike grensesnitt og domenemodeller (jf. delkapittel~\ref{sec:videomotorer}), måtte arkitekturen skille felles logikk fra backend-spesifikk logikk.
