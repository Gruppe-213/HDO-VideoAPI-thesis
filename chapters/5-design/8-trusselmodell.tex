...
VideoAPI, innførte tiltak og bevisste begrensninger i POC-et,
organisert etter STRIDE-kategoriene.
...
JWT, API-nøkler og pasientinformasjon logges ikke. Feilsvar med statuskode \texttt{5xx}
