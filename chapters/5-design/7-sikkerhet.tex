...
\textit{Logging av sensitive verdier.} Det er et eksplisitt krav i implementasjonen at JWT-tokens, API-nøkler og pasientinformasjon ikke loggføres (jf. delkapittel~\ref{sec:errors}); feilmeldinger er også utformet slik at logger primært bærer ressurs-ID-er og tjenestenavn.
