...
som er implementert i POC-et, men provider-arkitekturen er designet
for at nye motorer kan legges til uten endringer i API-kontrakten. Dette utdypes nærmere i delkapittel~\ref{sec:provider-validering}
...
API-et bruker \gls{json} for forespørsler og svar, og responsmodellene er normalisert
