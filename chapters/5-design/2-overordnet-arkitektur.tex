...
\begin{description}
    \item[HTTP-pipeline-laget] håndterer innkommende trafikk og inneholder middleware for blant annet unntakshåndtering, HTTPS, CORS, rate limiting, JWT-autentisering, autorisasjon og Prometheus-metrikker. Disse mekanismene er lagt i pipelinen fordi de gjelder hele API-et, ikke én spesifikk romoperasjon.
...
app.UseVideoApi();  // Middleware-kjeden i riktig rekkefølge
app.Run();
\end{lstlisting}
