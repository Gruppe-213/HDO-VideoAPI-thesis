...
Krav O1.1 \cite{hdo_kravspec} stiller krav om at API-nøkler, JWT-tokens
og annen konfidensiell informasjon ikke skal forekomme i logger.
Oppfyllelsen er sikret strukturelt: exception-klassene er utformet slik
at \texttt{Message}-feltet utelukkende inneholder ressurs-ID-er og
tjenestenavn. Siden \texttt{LogError}/\texttt{LogWarning} kun
videresender exception-objektet og en statisk streng, kan ingen
hemmelig informasjon nå logg-destinasjonen selv om en fremtidig
exception-type skulle konstrueres feil.
