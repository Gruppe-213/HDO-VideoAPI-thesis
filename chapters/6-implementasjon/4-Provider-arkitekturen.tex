...
Kodeliste~\ref{lst:ivideoproivder} viser grensesnittet.
...
Begge providers registreres med en typet \texttt{HttpClient} og en
\texttt{DelegatingHandler} for autentiseringshåndtering integrert i HTTP-pipelinen,
som vist i kodeliste~\ref{lst:providerregistrering}.
