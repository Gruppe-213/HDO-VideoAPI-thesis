...
I tråd med krav O1.1 \cite{hdo_kravspec} logges aldri API-nøkler, JWT-tokens eller pasientinformasjon. Exception-typene er bevisst utformet slik at meldingsfeltet kun inneholder ressurs-ID-er og tjenestenavn, og ikke potensielt sensitive verdier.
