...
public async Task<VideoRoom> CreateRoomAsync(CreateRoomRequest request, CancellationToken ct = default)
{
    ...
    // Bygg booking-objekt med tidspunkt og møtemal
    ...
    // Send booking til NHN og deserialiser respons
    ...
    // Returner booking konvertert til internt format
...
\begin{lstlisting}[language={[Sharp]C}, label=lst:nhn-token-cache, caption={Token-henting i \texttt{NHNAuthHandler}}]
// HDO-VideoAPI/Providers/NHN/NHNAuthHandler.cs
...
private async Task<string> GetTokenAsync(CancellationToken cancellationToken)
{
    ...
    var response = await base.SendAsync(
        new HttpRequestMessage(HttpMethod.Post, $"{_config.BaseUrl}/Token")
    {
    ...
    // Lagre token og beregn utløpstidspunkt
    cache.Token = result!.AccessToken;
    ...
    // Returner det oppdaterte tokenet
    return cache.Token;
}
\end{lstlisting}