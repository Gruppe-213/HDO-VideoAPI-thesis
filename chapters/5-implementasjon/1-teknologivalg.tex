...
\texttt{Microsoft.AspNetCore.Authentication.JwtBearer} & JWT-autentisering   & 10.0.5  \\
\texttt{Swashbuckle.AspNetCore}                        & OpenAPI/Swagger     & 10.1.1  \\
\texttt{prometheus-net.AspNetCore}                     & HTTP-metrikk        & 8.2.1   \\
\texttt{prometheus-net.AspNetCore.HealthChecks}        & Helsesjekk-metrikk  & 8.2.1   \\
\texttt{Microsoft.IdentityModel.Tokens}                & JWT-validering      & 8.16.0  \\
\texttt{DotNetEnv}                                     & Lokal .env-støtte   & 3.1.1   \\
\midrule
\multicolumn{3}{l}{\textit{Testprosjekt}} \\
\texttt{xunit}                                         & Testrammeverk       & 2.9.3   \\
\texttt{Moq}                                           & Mocking             & 4.20.72 \\
\texttt{Microsoft.AspNetCore.Mvc.Testing}              & Integrasjonstesting & 10.0.3  \\
\texttt{coverlet.collector}                            & Kodedekning         & 6.0.4   \\
\bottomrule
\end{tabular}
\end{table}