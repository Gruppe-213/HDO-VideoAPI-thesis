...
Den mest håndfaste tekniske læringen er C\# og .NET. Ingen i gruppen hadde
brukt språket eller rammeverket før prosjektstart, og på 19 uker har vi gått
fra å lese tutorials til å levere et API i produksjonsklar tilstand med
