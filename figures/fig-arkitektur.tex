...
\node[ext, fill=orange!25] (nhn) at ([xshift= 2.6cm, yshift=-1.4cm]cross.south) {\textbf{NHN Video (Pexip)}};

% --- External service on the right (Keycloak), aligned with Service-lag ---
\node[ext, fill=yellow!25] (kc) at ([xshift=4.6cm]svc.east) {\textbf{Keycloak}\\{\footnotesize OAuth2}};
...
\draw[->, dashed, black!60] (svc.east) -- (kc.west);
