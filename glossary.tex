...
\newglossaryentry{keycloak}{
    ...
    autorisasjonsserver for utstedelse av tilgangstokener til VideoAPI}
}
...
\newglossaryentry{demo-frontend}{
    ...
    teste funksjonaliteten til VideoAPI. Er ikke ment for produksjonsbruk, 
    men fungerer som et visuelt grensesnitt mot mellomvare-APIet}
}
...
\newglossaryentry{provider-adapter}{
    ...
    description={Konkret implementasjon av en provider som oversetter mellom VideoAPI sitt interne grensesnitt og en spesifikk videomotors API og dataformat}
}
...
\newglossaryentry{pull-request}{
    ...
    an annen. Brukes som kontrollpunkt for kodegjennomgang før endringer 
...
\newglossaryentry{LL-HLS}{
    ...
    utviklet av Apple for å redusere forsinkelse i videostrømming til under tre sekunder}
}
